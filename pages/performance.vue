...
<template>
  <div class="background">
    ...
    <ask class="box bottom"
      defaultText="满族传统的秧歌舞，又称扭秧歌或闹秧歌，是一项富有特色的民间歌舞艺术。这种群众性歌舞在满族社区中极为盛行，尤其在逢年过节，尤其是正月十五元宵节时更是热闹非凡。各村屯都会组织秧歌队，走街串巷，进行表演，为节日增添喜庆氛围。秧歌表演者的扮相丰富多彩，包括文人书生、老翁老妪等各种角色，形成了一场生动有趣的舞蹈和歌唱的盛宴。在表演中，歌舞交错，既有动感的舞步，又有富有情感的歌唱，呈现出丰富多样的文化内涵。" />
    <div class="layers">
